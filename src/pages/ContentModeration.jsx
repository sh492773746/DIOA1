...
const ContentModeration = () => {
    ...
    const fetchData = useCallback(async () => {
        ...
        let postsQuery = supabase.from('posts').select('*, author:profiles(id, username, avatar_url, tenant_id)').order('created_at', { ascending: false });
        let commentsQuery = supabase.from('comments').select('*, author:profiles(id, username, avatar_url, tenant_id), post:posts(content)').order('created_at', { ascending: false });
