...
const Profile = () => {
  const { user, profile: authProfile, loading: authLoading, signOut, isSuperAdmin, isTenantAdmin, appTenantId, siteSettings, supabaseClient } = useAuth();
  ...
  }, [userId, user, authLoading, isOwnProfile, authProfile, toast, isTenantAdmin, supabaseClient]);
