...
const Profile = () => {
  const { user, profile, loading, signOut, isSuperAdmin, isTenantAdmin, isInitialized } = useAuth();
  ...
  }, [fetchTenantRequest, user, isInitialized]);
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          <div className="flex flex-col items-center md:flex-row md:items-start gap-8">
              ...
              <div className="mt-4 flex flex-wrap justify-center md:justify-start gap-2">
                ...
                {canMakeNewRequest && (
                 ...
                 {(isSuperAdmin || isTenantAdmin) && (
                  <Button variant="secondary" onClick={handleAdminRedirect}>
            ...
            <Button variant="ghost" onClick={signOut} className="text-red-500 self-start mt-2 md:mt-0">
