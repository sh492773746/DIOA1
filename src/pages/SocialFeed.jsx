...
const PinnedAdsSection = () => {
  const { isInitialized, appTenantId } = useAuth();
...
const SocialFeed = () => {
  const { user, isInitialized, appTenantId, siteSettings } = useAuth();
  ...
  return (
    <>
      ...
      {user && <FloatingCreatePostButton onPostCreated={handlePostCreated} tenantId={appTenantId} />}
    </>
  );
};
