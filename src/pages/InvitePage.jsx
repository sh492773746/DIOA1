...
const InvitePage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>你被邀请了！加入大海团队官网</title>
        <meta name="description" content="通过邀请链接加入大海团队官网，探索更多精彩内容！" />
        <meta property="og:title" content="你被邀请了！加入大海团队官网" />
        <meta property="og:description" content="通过邀请链接加入大海团队官网，探索更多精彩内容！" />
      </Helmet>
          ...
          <Card className="w-full max-w-md bg-white/90 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 text-center">
            <CardHeader className="pt-10">
              <motion.div
                ...
                className="mx-auto w-24 h-24 rounded-full flex items-center justify-center shadow-lg overflow-hidden"
              >
                <img  class="w-full h-full object-cover" alt="大海团队官网Logo" src="https://images.unsplash.com/photo-1633335380138-a64bcef84efe" />
              </motion.div>
